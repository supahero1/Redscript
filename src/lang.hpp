...
void prune_expr(rbc_program&, rs_expression&, rs_error*);
...
rs_expression expreval(rbc_program& program, token_list& tlist, long& start, rs_error* err, bool = false, bool = true, bool obj = false);
